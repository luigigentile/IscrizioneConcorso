<template lang="html">
  ...
  <div class="container" id="da_stampare">
        ...
        <div class="card-header">
            <p><strong>PRENOTAZIONE:</strong>
                <a href="#" title="Inserisci turni  prenotazione">
                    <img @click="setDisplayInsertPrenotazione" src="../assets/icon-addlink.svg" alt="Nuova Prenotazione">
                </a>
    ...
    <div class="container table-striped" v-for="(prenotazione,index) in movimentiPrenotazione"   :key="index">
        <div class="row">
    <!--    icona delete     -->
        <router-link title="delete prenotazione"
    ...
    <!--    icona modifica     -->
            <a href="#" title="Modifica Prenotazione">
